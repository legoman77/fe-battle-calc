...
def attack():
    ...
    global defender_evade
      ...
      if defender_current_hp > 0:
          ...
          defender_crit_roll_1 = random.randint(1,100)

          # Defender gets a crit

          if defender_crit_roll_1 <= defender_crit_chance:
              print(defender_name + " got a critical hit!")
              defender_hit_roll_1 = random.randint(1,100)

              # Defender hits crit

              if defender_hit_roll_1 <= defender_accuracy:
  ...
  # Defender is dead
      ...
      if defender_current_hp > 0:
        ...
        defender_crit_roll_2 = random.randint(1,100)

        # Defender gets a crit

        if defender_crit_roll_2 <= defender_crit_chance:
            print(defender_name + " got a critical hit!")
            defender_hit_roll_2 = random.randint(1,100)

            # Defender hits crit

            if defender_hit_roll_2 <= defender_accuracy:
                attacker_current_hp = attacker_current_hp - defender_crit_damage
                defender_weapon_uses -= 1
                print(attacker_name + " took " + str(defender_crit_damage) + " damage!")
                if defender_weapon_uses <= 0:
      ...
      if defender_class in defender_classes:
          ...
          if defender_current_hp > 0:
              ...
              if defender_level < 30:
                  ...
                  if defender_hit_roll_1 <= defender_accuracy or defender_hit_roll_2 <= defender_accuracy:
