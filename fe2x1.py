...
def attack():
    ...
    global defender_evade
      ...
      attacker_crit_roll_1 = random.randint(1,100)

      # Attacker gets a crit

      if attacker_crit_roll_1 <= attacker_crit_chance:
          print(attacker_name + " got a critical hit!")
          attacker_hit_roll_1 = random.randint(1,100)
          
          # Attacker hits crit

          if attacker_hit_roll_1 <= attacker_accuracy:
  ...
  # Defender is dead
      ...
      if attacker_current_hp > 0:
        ...
        attacker_crit_roll_2 = random.randint(1,100)

        # Attacker gets a crit

        if attacker_crit_roll_2 <= attacker_crit_chance:
            print(attacker_name + " got a critical hit!")
            attacker_hit_roll_2 = random.randint(1,100)

            # Attacker hits crit

            if attacker_hit_roll_2 <= attacker_accuracy:
                defender_current_hp = defender_current_hp - attacker_crit_damage
                attacker_weapon_uses -= 1
                print(defender_name + " took " + str(attacker_crit_damage) + " damage!")
                if attacker_weapon_uses <= 0:
      ...
      if attacker_class in attacker_classes:
          ...
          if attacker_current_hp > 0:
              ...
              if attacker_level < 30:
                  ...
                  if attacker_hit_roll_1 <= attacker_accuracy or attacker_hit_roll_2 <= attacker_accuracy:
